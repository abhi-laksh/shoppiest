...
import { FormControl, InputLabel, Input, InputAdornment, makeStyles, Typography } from '@material-ui/core';

import { styledBy } from "../../../helpers/styles";
import clsx from 'clsx';
import { validAscents } from '../../../constants/propTypesValidation';
import { withFormWatcher } from '../HOC/withFormWatcher';
...
const TextBox = ({
    ...
    return (
        <FormControl fullWidth {...props} className={parentClassName}>
            {
                showLabel ? (
                    <InputLabel
...
export default withFormWatcher(TextBox);